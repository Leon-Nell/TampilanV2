...
echo "";
echo -e "\e[1;34m[*] \e[32minstall bentar niichan....\e[0m";
echo "";
...
if [ -e $PREFIX/share/figlet/Remo773.flf ]; then
	echo -e "\e[1;34m[*] \033[32mLeonHell.flf figlet font is present\033[0m";
	sleep 4
else
}
# note this is only print 7 charecters
...
do
	echo ""
tput setaf 3
read -p "Pleas enter Name 
minimal 9 karakter: " PROC
tput sgr 0
if [[ ${#PROC} -gt 8 ]]; then
...
\033[0m";
	echo ""
	echo -e "\e[1;34m \033[32m9 kata tok anjime...\033[0m"
	echo ""
else
	ok=1
fi
...
#echo -e '\033[1;43;30m### SUBSCRIBE MY YOUTUBE CHANNEL Leon Hell ### \033[0m';
#echo -e '\e[0;35m+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+\e[00m';
echo "";
echo -e "
...
tput setaf 3
read -p  "Apakah Anda ingin mengatur ini ? (y/n) " PROC32
tput sgr 0
if [[ ${PROC32} == [Y/y] ]]; then
...
clear;
echo -e "\033[31m$(figlet -f Remo773 "Cyber Leon")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
Leon Hell : (\e[33m14.4.2021\e[32m)
...
\033[0m";
tput setaf 3;
read -p  "Apakah Anda ingin mengatur ini ? (y/n) " PROC33
...
echo -e "\e[1;34m[*] \e[32mdownload gagal, modar o..\e[0m";
...
if [ -d $HOME/.plugins/zsh-syntax-highlighting ];then
  ...
  THEADER
	...
	echo -e "\e[1;34m[*] \033[32mSemoga kalian suka..\033[0m"
	exit
fi
exit 0
